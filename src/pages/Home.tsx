    ...
    >
      ...
      >
        <div className="flex justify-center">
          Mach-Typer is a typing application used to encourage people to develop
          their typing skills with a game-ified application.
        </div>
        <Link
      ...
      <footer
        className="flex flex-col bg-secondary gap-4
        text-white p-8 rounded"
      >
